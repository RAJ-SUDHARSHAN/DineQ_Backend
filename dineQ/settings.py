"""
Django settings for dineQ project.
...
ALLOWED_HOSTS += ["fec0-2601-644-9381-d770-35b1-e3a1-45c2-94be.ngrok-free.app"]
...
WSGI_APPLICATION = "dineQ.wsgi.application"
